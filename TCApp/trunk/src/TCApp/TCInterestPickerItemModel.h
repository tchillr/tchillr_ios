...
@interface TCInterestPickerItemModel : NSObject
...
- (TCInterestPickerItemModel *)initWithTitle:(NSString *)title backgroundColor:(UIColor *)bgColor andTitleColor:(UIColor *)titleColor;
